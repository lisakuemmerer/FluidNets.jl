...
'make_model' contains a structure on how to build a neural network. can be used directly with only a few input parameters.  
'run_trials' contains an example on how to run the hyperparameter optimization. can be used directly with only a few input parameters.  
'evaluate_trials' contains some suggestions to evaluate the hyperparameter optimization. 
